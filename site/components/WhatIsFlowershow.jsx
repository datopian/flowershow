export function WhatIsFlowershow() {
  return (
        ...
        <div className="not-prose my-12 grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div className="group relative rounded-xl border border-slate-200 dark:border-slate-800">
            ...
            <div className="relative overflow-hidden rounded-xl p-6">
              <img src="/assets/images/obsidian_icon.png" alt="" className="h-12 w-auto" />
          ...
          <div className="group relative rounded-xl border border-slate-200 dark:border-slate-800">
            ...
            <div className="relative overflow-hidden rounded-xl p-6">
              <img src="/assets/images/park.png" alt="" className="h-12 w-auto" />
          ...
          <div className="group relative rounded-xl border border-slate-200 dark:border-slate-800">
            ...
            <div className="relative overflow-hidden rounded-xl p-6">
              <img src="/assets/images/farming.png" alt="" className="h-12 w-auto" />
          ...
          <div className="group relative rounded-xl border border-slate-200 dark:border-slate-800">
            ...
            <div className="relative overflow-hidden rounded-xl p-6">
              <img src="/assets/images/data.png" alt="" className="h-12 w-auto" />
